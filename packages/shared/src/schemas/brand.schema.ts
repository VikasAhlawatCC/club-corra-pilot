...
export const brandSchema = z.object({
  ...
  earningPercentage: z.number().min(0, 'Earning percentage must be non-negative').max(100, 'Earning percentage cannot exceed 100').default(10),
  redemptionPercentage: z.number().min(0, 'Redemption percentage must be non-negative').max(100, 'Redemption percentage cannot exceed 100').default(30),
