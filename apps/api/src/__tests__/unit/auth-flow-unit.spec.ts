...
describe('Authentication Flow Unit Tests', () => {
  ...
  describe('User Registration Flow', () => {
    it('should handle user signup successfully', async () => {
      ...
      expect(otpService.generateOtp).toHaveBeenCalledWith('9876543210', 'SMS');
  ...
  describe('OTP Verification Flow', () => {
    it('should handle OTP verification successfully', async () => {
      ...
      jest.spyOn(usersService, 'updateUser').mockResolvedValue(mockUser as any);
      ...
      expect(otpService.verifyOtp).toHaveBeenCalledWith('9876543210', '123456', 'SMS');
    ...
    it('should handle invalid OTP', async () => {
      ...
      expect(otpService.verifyOtp).toHaveBeenCalledWith('9876543210', 'invalid', 'SMS');
    });
  });

  describe('Login Flow', () => {
    it('should handle mobile login successfully', async () => {
